...
import { BookOpen, ChevronRight, Search, X, Bookmark, History, LogIn } from 'lucide-react-native';
...
export default function BibleScreen() {
  ...
  // Only show continue reading if authenticated and has reading position
  const showContinueReading = isAuthenticated && lastReadingPosition;
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      {/* Continue Reading Section - Only show if authenticated */}
      {showContinueReading && activeTab === 'books' && (
        ...
        <>
          {isAuthenticated ? (
            ...
            <View style={styles.authPrompt}>
              ...
              <Text style={[styles.authPromptTitle, { color: colors.text }]}>Sign in to view bookmarks</Text>
              <Text style={[styles.authPromptSubtitle, { color: colors.textLight }]}>
                Create an account to save your favorite verses and reading progress
              </Text>
              <TouchableOpacity
                style={[styles.authPromptButton, { backgroundColor: colors.primary }]}
                onPress={() => router.push('/(auth)/login')}
              >
                <Text style={[styles.authPromptButtonText, { color: colors.white }]}>Sign In</Text>
              </TouchableOpacity>
            </View>
          )}
        </>
