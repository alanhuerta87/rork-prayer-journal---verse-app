...
export const VerseCard: React.FC<VerseCardProps> = ({ verse }) => {
            ...
            {backgroundOptions.map((option) => (
              ...
              >
                ...
                {option.type === 'gradient' && option.colors && (
                  <LinearGradient colors={option.colors as readonly [string, string, ...string[]]} style={styles.backgroundPreview} />
                )}
  ...
  const renderCard = () => {
    ...
    if (selectedBackground.type === 'gradient' && selectedBackground.colors) {
      return (
        <LinearGradient colors={selectedBackground.colors as readonly [string, string, ...string[]]} style={styles.backgroundImage}>
          <View style={styles.overlay}>
            <CardContent />
          </View>
        </LinearGradient>
